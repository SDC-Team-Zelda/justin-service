        ...
        <div className={styles.grid}>
          <div className={styles.header}>
            <div className={styles.leftArrowContainer} onClick={this.changeMonth} id="left">
              <img className={styles.leftArrow} src="http://18.191.183.167:3003/img/arrow.svg" alt="arrow"></img>
            </div>
            <div className={styles.date}>
              {`${currentMonthString} ${currentYear}`}
            </div>
            <div className={styles.rightArrowContainer} onClick={this.changeMonth} id="right">
              <img className={styles.rightArrow} src="http://18.191.183.167:3003/img/arrow.svg" alt="arrow"></img>
            </div>
          </div>
