        ...
        <div className={styles.row}>
          ...
          <div className={`${styles.btn} numAdults`}>
            <span className={`${styles.minus} ${(numAdults === 1) ? styles.inactive : ""} numAdults`} onClick={onMinusClick}>
              <img className={styles.minusSign} src="http://ec2-3-17-71-200.us-east-2.compute.amazonaws.com:3003/img/minus.svg" alt="minus sign"></img>
            </span>
            ...
            <span className={`${styles.plus} ${(numChildren + numAdults === max_guests) ? styles.inactive : ""} numAdults`} onClick={onPlusClick}>
              <img className={styles.plusSign} src="http://ec2-3-17-71-200.us-east-2.compute.amazonaws.com:3003/img/plus.svg" alt="plus sign"></img>
            </span>
          </div>
        </div>
        <div className={styles.row}>
