...
class BookingBar extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://localhost:3003/api/rental${queryString}`)
      .then(res => {
      ...
      <div>
        <div className={styles.wrapper}>
          ...
          <p className={styles.reviews}>
            <img src="http://ec2-3-136-154-116.us-east-2.compute.amazonaws.com:3003/img/star.svg" alt="star" className={styles.star}></img>
          ...
          <div className={styles.barWrapper}>
            ...
            <div className={styles.bar}>
              ...
              <img className={styles.arrow} src="http://ec2-3-136-154-116.us-east-2.compute.amazonaws.com:3003/img/arrow.svg" alt="arrow"></img>
